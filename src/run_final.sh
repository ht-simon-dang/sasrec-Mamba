...
python run.py --config-name=MAMBA4Rec data_path=../data/ml-1m.txt dataset.max_length=200
...
python run.py --config-name=MAMBA4Rec data_path=../data/beauty.txt
...
python run.py --config-name=MAMBA4Rec data_path=../data/steam.txt
...
python run.py --config-name=MAMBA4Rec data_path=../data/yelp.txt
...
python run.py --config-name=MAMBA4Rec data_path=../data/ml-20m.txt dataset.max_length=200 model_params.input_size=256 model_params.hidden_size=256
